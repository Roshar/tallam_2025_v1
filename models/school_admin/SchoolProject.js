...
exports.getAllTeachersFromThisSchoolFromCurrentProject = async (req, res) => {
  try {
    ...
    const [
      ...
      " SELECT teachers.id_teacher, teachers.firstname, teachers.surname, teachers.patronymic, teachers.position, position.title_position, position.id_position " +
        " FROM " +
        name_table_project +
        ...
        " WHERE teachers.school_id = ? AND mpt.in_project_status = ? ORDER BY teachers.surname  ASC ",
      [school_id, 2]
    );
