...
const {validatorForAddMarkMethod} = require('../../utils/validator_card_method')
...
router.get('/check/project/:project_id/teacher/:teacher_id', school_cardCtrl.checkCard)
router.post('/add/project/:project_id/teacher/:teacher_id/all', validatorForAddMark, school_cardCtrl.addMarkForTeacherAll)
router.get('/add/project/:project_id/teacher/:teacher_id/all', school_cardCtrl.addMarkForTeacherAll)
router.post('/add/project/:project_id/teacher/:teacher_id/method', validatorForAddMarkMethod, school_cardCtrl.addMarkForTeacherMethod)
router.get('/add/project/:project_id/teacher/:teacher_id/method', school_cardCtrl.addMarkForTeacherMethod)
